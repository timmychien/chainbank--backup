    ...
    */
    constructor() public{
      ...
      //mint credit
        ...
        */
    //swap tokens
        function swap_to_token(bytes32 creditID,uint amount)public returns(bool){
          //address _from=msg.sender;
          //credit=ERC865Token(addr_issue);
          //ERC865Token platform_token=ERC865Token(0x2Dccb2c99B63ee86cCd28A6C9369AA54439EBa61);
          address platform_token=0x2Dccb2c99B63ee86cCd28A6C9369AA54439EBa61;
          require(credits[creditID].available_Amount>amount);
          bytes memory approve_swap = abi.encodeWithSignature("_approve(address,address,uint256)",msg.sender,platform,amount);
	      platform_token.call(approve_swap);
	      
	      bytes memory transferFrom_swap=abi.encodeWithSignature("transform(address,address,uint256",platform,msg.sender,amount);
	      platform_token.call(transferFrom_swap);
          credits[creditID].available_Amount=credits[creditID].available_Amount.sub(amount);
          balances[msg.sender]=balances[msg.sender].sub(amount);
          //platform_token._approve(msg.sender,platform,amount);
          transferFrom(msg.sender,platform,amount);
