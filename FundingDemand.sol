...
contract Credit is ERC865Token{
    ...
    mapping(uint=>MarginCredit)public credits;
    //modifier
    ...
    */
    constructor(address borrower,bool Default,uint256 amount,uint8 rate,bool CAM) public{
        totalSupply_=Initial_Supply;
        //balances[borrower]=Initial_Supply;
        //platform=0x14723A09ACff6D2A60DcdF7aA4AFf308FDDC160C;
        platform=0x63A40281087c53479382283dE03d64A83f5C7df0;
    ...
    //
        ...
        onlyMinter
        //returns(bool)
        //returns(address,bool,uint256,uint256,uint8,bool)
        returns(uint,MarginCredit memory)
        {
            ...
            //return (receipt.spender,receipt.isDefault,receipt.marginAmount,receipt.available_Amount,receipt.payrate,receipt.isCAM);
        }
        /*
    ...
    //銷毀憑證
        function burn_margin_credit(address borrower,uint256 amount)public{
