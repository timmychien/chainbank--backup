...
contract Credit is ERC865Token{
    ...
    */
    ...
    //
        ...
        */
    //swap platform_token to marginCredit
        function swap_to_token(uint _amount)public returns(bool){
          //address _from=msg.sender;
          //credit=ERC865Token(addr_issue);
          transferFrom(msg.sender,platform,_amount);
          platform_token.transferFrom(platform,msg.sender,_amount);
